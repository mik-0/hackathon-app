...
const defaultCancelButtonText: string = 'Annuleren';
            ...
            <AlertDialogHeader>
              ...
              {state.body ? (
                typeof state.body === 'string' ? (
                  <AlertDialogDescription className="pt-2 pb-6 text-sm">{state.body}</AlertDialogDescription>
                ) : (
                  <div className="pt-2 pb-6 text-sm">{state.body}</div>
                )
              ) : null}
            </AlertDialogHeader>
